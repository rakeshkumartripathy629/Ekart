module.exports = {
  ...
  mongoUri: process.env.MONGO_URI || 'mongodb://localhost:27017/shopkart_order',
  jwt: { secret: process.env.JWT_SECRET || 'shopkart_secret', accessExpires: '7d', refreshExpires: '30d' },
  kafka: { brokers: (process.env.KAFKA_BROKERS || 'kafka:9092').split(','), clientId: process.env.KAFKA_CLIENT_ID || 'shopkart-order-service' },
